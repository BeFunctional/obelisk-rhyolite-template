...
albanyParcelsQuery = do
  ...
  pure $ toGeoJSON_ (mapGeom_ toWGS84FromSPWYEMeters_ parcels)
...
laramieParcelsQuery =
  toGeoJSON_ . mapGeom_ toWGS84FromSPWYEMeters_ <$> all_ laramieParcels_

-- toGeoJSON_ . mapGeom_ toWGS84FromSPWYE_ <$> all_ laramieParcels_
